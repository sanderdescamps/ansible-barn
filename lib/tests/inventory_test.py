...
if __name__ == '__main__':
    ...
    inventory_database = MongoInventoryDB(
        '10.10.6.17', 27017, "admin-user", "jfldmdpdeiehjkHGSthjjhDdfghhFdf")
    ...
    inventory_database.set_variable(
        "srvdns01.myhomecloud.be", "env_environment", "development")
    inventory_database.set_variable(
        "srvdns01.myhomecloud.be", "env_environment", "test")
    inventory_database.add_group("dns_servers")
    inventory_database.set_variable(
        "dns_servers", "description", "Dit zijn de DNS servers")
    inventory_database.add_host_to_group(
        "srvdns01.myhomecloud.be", "dns_servers")
    inventory_database.add_host_to_group(
        "srvdns02.myhomecloud.be", "dns_servers")
    ...
    print("vars of srvdns01: ", inventory_database.get_vars(
        "srvdns01.myhomecloud.be"))
    print("vars of dns_servers group: ",
          inventory_database.get_vars("dns_servers"))
