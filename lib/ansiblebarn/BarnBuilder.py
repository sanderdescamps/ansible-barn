...
from ansiblebarn.InventoryDB.ElasticInventoryDB import ElasticInventoryDB
from ansiblebarn.InventoryDB import BarnTypeNotSupported
from ansiblebarn.BarnConfigManager import BarnConfigManager, find_barn_config_file
import configparser
import os
    ...
    def get_instance(self):
        if self.config_manager.get_config_value("barn_inventory_type") == "mongodb":
            return MongoInventoryDB(self.config_manager.get_config_value("barn_hostname"),
                                    port=self.config_manager.get_config_value(
                                        "barn_port"),
                                    username=self.config_manager.get_config_value(
                                        "barn_user"),
